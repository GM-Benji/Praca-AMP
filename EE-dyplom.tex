...
\promotor{STOPIEŃ I NAZWISKO PROMOTORA}
\date{2024}
\longdate{2024-06-15}
...
\begin{document}
    ...
    \input{tekst/01_wstep}
    \input{tekst/02_stanowisko}
    \input{tekst/03_architektura}
    \input{tekst/04_kompilacja}
    \input{tekst/05_sprzet_dtb}
    \input{tekst/06_sterowniki}
    \input{tekst/07_bare_metal}
    \input{tekst/08_podsumowanie}
